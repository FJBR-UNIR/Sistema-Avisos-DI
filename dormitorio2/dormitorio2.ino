...
lcd.begin(16,2);
lcd.setCursor(0,0);
lcd.write("DORMITORIO ON - UNIR");
lcd.setCursor(0,1);
lcd.write("Fran. Berchez R.");
delay(2000);
lcd.clear();
tonomensaje();
mostrarmensajes("DORMITORIO","INICIANDO...");  
delay(3000);
lcd.clear();
...
luces();
mostrarmensajes("AL SALIR","APAGAR LUCES");
myDFPlayer.playFolder(15, 50); 
delay(3000);  
  if (now.hour()>=22 && now.hour()<=23){
    tonomensaje();
    luces();
    mostrarmensajes("ACTIVAR","ALARMA DE SEGURIDAD");
